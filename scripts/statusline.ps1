...
$KaoLegend = '彡☆（●ᴗ●）☆ミノ#ヽ彡☆（●ᴗ●）☆ミ#彡☆（●o●）☆ミノ#ヽ彡☆（●ᴗ●）☆ミ|ψ（╬◣_◢）ψ!#!ψ（◣_◢╬）ψ#ψ（╬◣o◢）ψ!#!ψ（◣_◢╬）ψ|≪（▼_▼）≫†#†≪（▼_▼）≫#≪（▼‿▼）≫†#†≪（▼_▼）≫|⊰（◕‿◕）⊱☆#☆⊰（◕‿◕）⊱#⊰（◕ᴗ◕）⊱☆#☆⊰（◕‿◕）⊱|༺（◈ω◈）༻ζ#ζ༺（◈ω◈）༻#༺（◈▽◈）༻ζ#ζ༺（◈ω◈）༻'
...
$TalkDone = @{
    common = @('왕!', '냥!', '뿌!', '삐약!', '꽥!', '음냐', '냥냥! 참치 있냥?', '뿌! 배고프다뿌', '삐약... 병아리는 아닌데')
    uncommon = @('왕왕!', '다했다!', '끝!', '됐다!', '오케이!', '히히', '다했다! 간식 줘!', '끝! 나 잘했지?', '됐다! 커피콩은 왜 콩일까')
    rare = @('다 됐어요', '끝났어요', '완료했어요', '해냈어요!', '준비 끝!', '끝났어요. 제일 뜨거운 과일은 천도복숭아래요', '다 됐어요. 왕이 넘어지면? 킹콩!', '완료! 소가 웃는 소리는? 우하하')
    unique = @('작업 완료했어요!', '다 끝냈습니다!', '깔끔하게 끝냈어요!', '확인해 보세요!', '다 끝냈습니다! 쉬는 날에도 코드 꿈을 꿔요', '완료했어요! 버그도 잡고 웃음도 잡을게요', '깔끔하게 끝냈어요! 이 정도면 승진 각이죠?')
    legend = @('요청하신 작업 모두 완료했습니다!', '전부 끝냈습니다, 확인 부탁드려요!', '작업을 성공적으로 마쳤습니다!', '모두 마쳤습니다. 오늘의 넌센스: 물고기의 반대말은? 불고기.', '완료했습니다. 세상에서 가장 빠른 새는? 눈 깜짝할 새.', '끝났습니다. 가장 오래된 나무는? 갈매나무.')
