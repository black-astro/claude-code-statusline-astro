...
얼굴마다 영어 이름이 하나씩 있습니다. 위 예시라면 `Blossom`입니다. 뽑히면 자기소개를 하고, 일하다가 가끔 등급에 맞는 농담도 던집니다.
...
작업하는 동안에는 표정도 번갈아 바뀝니다. 레전드는 고개를 좌우로 돌리고 가끔 입 모양도 달라집니다.
...
| **Wrath** | ![Wrath](docs/legend/legend-2.svg) | ![](docs/legend/swatch-2.svg) |
| **Overlord** | ![Overlord](docs/legend/legend-3.svg) | ![](docs/legend/swatch-3.svg) |
| **Seraph** | ![Seraph](docs/legend/legend-4.svg) | ![](docs/legend/swatch-4.svg) |
| **Wyvern** | ![Wyvern](docs/legend/legend-5.svg) | ![](docs/legend/swatch-5.svg) |

| 이름 | 표정 |
| --- | --- |
| **Halo** | `彡☆（●ᴗ●）☆ミノ` · `ヽ彡☆（●ᴗ●）☆ミ` · `彡☆（●o●）☆ミノ` · `ヽ彡☆（●ᴗ●）☆ミ` |
| **Heartthrob** | `♡ヽ（♥‿♥）ノ♥` · `♥ヽ（♥‿♥）ノ♡` · `♡ヽ（♥ᴗ♥）ノ♥` · `♥ヽ（♥‿♥）ノ♡` |
| **Bliss** | `◇°（ﾉ≧∇≦）ﾉ°◆` · `◆°（ﾉ≧∇≦）ﾉ°◇` · `◇°（ﾉ≧ω≦）ﾉ°◆` · `◆°（ﾉ≧∇≦）ﾉ°◇` |
| **Serenade** | `♪°·（๑ᴖ◡ᴖ๑）·°♬` · `♬°·（๑ᴖ◡ᴖ๑）·°♪` · `♪°·（๑ᴖoᴖ๑）·°♬` · `♬°·（๑ᴖ◡ᴖ๑）·°♪` |
| **Monarch** | `·°◇（￣ヘ￣）◆°·` · `·°◆（￣ヘ￣）◇°·` · `·°◇（￣〜￣）◆°·` · `·°◆（￣ヘ￣）◇°·` |
| **Wrath** | `ψ（╬◣_◢）ψ!` · `!ψ（◣_◢╬）ψ` · `ψ（╬◣o◢）ψ!` · `!ψ（◣_◢╬）ψ` |
| **Overlord** | `≪（▼_▼）≫†` · `†≪（▼_▼）≫` · `≪（▼‿▼）≫†` · `†≪（▼_▼）≫` |
